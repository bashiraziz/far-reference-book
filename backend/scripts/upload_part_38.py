"""Upload Part 38 to Qdrant production database."""
import asyncio
import sys
...
async def main():
    """Upload Part 38 to production database."""
    logger.info("=== Uploading Part 38 to Production Database ===\n")
    ...
    chunk_iterator = iter_document_chunks(38, docs_dir)
