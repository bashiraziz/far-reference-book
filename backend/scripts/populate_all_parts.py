"""
Script to populate Qdrant vector database with ALL FAR Parts (1-53).

Reads FAR markdown files, chunks them, generates embeddings, and uploads to Qdrant.
This is a comprehensive script that ensures all parts are in the vector database.
"""
...
async def main():
    ...
    logger.info("=== FAR Vector Database Population (ALL PARTS 1-53) ===\n")
    ...
    logger.info("\nProcessing ALL FAR documents (Parts 1-53)...")
    ...
    logger.info(f"\nAll FAR parts (1-53) have been populated into Qdrant!")
