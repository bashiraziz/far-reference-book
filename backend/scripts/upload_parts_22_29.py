"""Upload Parts 22-29 to Qdrant production database."""
import asyncio
import sys
...
async def main():
    """Upload Parts 22-29 to production database."""
    logger.info("=== Uploading Parts 22-29 to Production Database ===\n")
    ...
    chunk_iterator = iter_document_chunks(docs_dir, start_part=22, end_part=29)
