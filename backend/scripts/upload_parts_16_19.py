"""Upload Parts 16-19 to Qdrant production database."""
import asyncio
import sys
...
async def main():
    """Upload Parts 16-19 to production database."""
    logger.info("=== Uploading Parts 16-19 to Production Database ===\n")
    ...
    logger.info("Note: Part 20 has no markdown files and will be skipped\n")

    chunk_iterator = iter_document_chunks(docs_dir, start_part=16, end_part=20)
