"""Upload Part 10 to Qdrant production database."""
import asyncio
import sys
...
async def main():
    """Upload Part 10 to production database."""
    logger.info("=== Uploading Part 10 to Production Database ===\n")
    ...
    chunk_iterator = iter_document_chunks(10, docs_dir)
