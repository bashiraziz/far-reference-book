"""Upload Parts 11-15 to Qdrant production database."""
import asyncio
import sys
...
async def main():
    """Upload Parts 11-15 to production database."""
    logger.info("=== Uploading Parts 11-15 to Production Database ===\n")
    ...
    chunk_iterator = iter_document_chunks(docs_dir, start_part=11, end_part=15)
