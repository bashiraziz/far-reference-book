"""
Script to populate Qdrant vector database with FAR Parts 26-53.
...
async def main():
    ...
    logger.info("=== FAR Vector Database Population (Parts 26-53) ===\n")
    ...
    logger.info("\nProcessing FAR documents (Parts 26-53)...")
    chunk_iterator = iter_document_chunks(docs_dir, start_part=26, end_part=53)
