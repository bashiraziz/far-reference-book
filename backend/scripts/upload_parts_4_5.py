"""Upload Parts 4-5 to Qdrant production database."""
import asyncio
import sys
...
async def main():
    """Upload Parts 4-5 to production database."""
    logger.info("=== Uploading Parts 4-5 to Production Database ===\n")
    ...
    chunk_iterator = iter_document_chunks(docs_dir, start_part=4, end_part=5)
