---
id: 16.402-2
title: "16.402-2 Performance incentives"
sidebar_label: "16.402-2"
---
...
both in development (when performance objectives are known and the fabrication of prototypes for

test and evaluation is required) and in production (if improved performance is attainable and highly

desirable to the Government).

(d) Technical performance incentives may involve a variety of specific characteristics that contribute
...
precision, and data interpretation) and performance standards (such as the quality levels of services
...
(h) The contracting officer  must  exercise care, in establishing performance criteria, to recognize that
