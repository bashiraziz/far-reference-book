...
contained in Table  15-2  of FAR 15.408 , which is incorporated by reference with the same force and
...
Alternate I (Oct2010) . As prescribed in 15.408 (l) (and see 15.403-5 (b)(1)), substitute the following
...
proposed price in accordance with 15.408 , Table  15-2 , Note 2. The description may be inserted at
...
Alternate II (Oct1997) . As prescribed in 15.408 (l), add the following paragraph (c) to the basic
...
Alternate III (Oct1997) . As prescribed in 15.408 (l), add the following paragraph (c) to the basic
...
Alternate IV (Oct2010) . As prescribed in 15.408 (l), replace the text of the basic provision with the
