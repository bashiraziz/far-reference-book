...
Regulation (FAR) 52.212-3  (see FAR 52.212-3 (b) for those representations and certifications that the
...
consistent with FAR subpart  4.10 ), or alternative commercial products  or commercial services  for
...
subpart  32.11 ) for the same entity. If the Offeror does not have a unique entity identifier, it should
