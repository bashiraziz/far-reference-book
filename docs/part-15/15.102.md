...
timing (see 15.208 ) and content (see 15.306 ). Oral presentations provide an opportunity for dialogue
...
provisions at 52.204-8 (d) or 52.212-3 (b), and a signed offer  sheet (including any exceptions to the
...
(see 15.306 (d)) will be permitted during oral presentations.
