---
id: 15.406-3
title: "15.406-3 Documenting the negotiation"
sidebar_label: "15.406-3"
---

# 15.406-3 Documenting the negotiation

(a) The contracting officer  shall  document in the contract file the principal elements of the

negotiated agreement. The documentation ( e.g., price  negotiation memorandum (PNM)) shall
...
the certified cost or pricing data  threshold, the exception used and the basis for it.
...
(ii) Recognized as inaccurate, incomplete, or noncurrent any certified cost or pricing data  submitted;
...
negotiated position. Where the determination of a fair and reasonable price  is based on cost

analysis, the summary shall  address each major cost element. When determination of a fair and

reasonable price  is based on price  analysis, the summary shall  include the source and type of data
...
(9) To the extent such direction has a significant effect on the action, a discussion and quantification

of the impact of direction given by Congress, other agencies, and higher-level officials ( i.e., officials

who would not normally exercise authority during the award and review process for the instant
...
(b) Whenever field pricing  assistance has been obtained, the contracting officer  shall  forward a copy

of the negotiation documentation to the office(s) providing assistance. When appropriate,

information on how advisory field support can be made more effective should  be provided
